    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <form class="form-signin" id="loginForm" action="jsp" role="form" method="post">                                    
                ...
                %>
                <input value="cristina" class="form-control"  id="inputLogin" type="text" placeholder="nombre de usuario" required="" autofocus="" name="login" />                                                    
                <%
                } else {
                %>
                ...
                <%
                    if (EstadoHelper.getTipo_estado() == EstadoHelper.getTipo_estado().Debug) {
                %>
                <input value="cristina" class="form-control" type="password" id="inputPassword" placeholder="contraseña"  required="" name="password" />                                                               
                <%
                } else {
                %>
