...
<div class="panel panel-primary">
    ...
    <div class="list-group">
        <a class="list-group-item" id="lnkPublicacion" href="jsp#/usuario">Usuario</a>
        <a class="list-group-item" id="lnkPublicacion" href="jsp#/tipousuario">Tipo de usuario</a>
        <a class="list-group-item" id="lnkPublicacion" href="jsp#/actividad">Actividad</a>
        <a class="list-group-item" id="lnkPublicacion" href="jsp#/tipoactividad">Tipo de actividad</a>
    </div>    
</div>
