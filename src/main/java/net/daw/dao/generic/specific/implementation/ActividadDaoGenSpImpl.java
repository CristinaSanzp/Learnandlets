...
public class ActividadDaoGenSpImpl extends TableDaoGenImpl<ActividadBeanGenSpImpl> {

    public ActividadDaoGenSpImpl(String strFuente, Connection pooledConnection) throws Exception {
        super(strFuente, "Actividad", pooledConnection);
    }
