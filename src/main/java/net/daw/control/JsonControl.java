...
import net.daw.control.operation.generic.specific.implementation.ActividadControlOperationGenSpImpl;
import net.daw.control.operation.generic.specific.implementation.TipoactividadControlOperationGenSpImpl;
import net.daw.control.operation.specific.implementation.PostControlOperationSpImpl;
import net.daw.control.route.generic.specific.implementation.ActividadControlRouteGenSpImpl;
...
import net.daw.control.route.generic.specific.implementation.ActividadControlRouteGenSpImpl;
import net.daw.control.route.generic.specific.implementation.TipoactividadControlRouteGenSpImpl;
            ...
            if (request.getSession().getAttribute("usuarioBean") != null) {
                ...
                switch (ParameterCooker.prepareObject(request)) {
                    ...
                    case "tipousuario":
                        ...
                        break;
                    case "actividad":
                        ActividadControlRouteGenSpImpl oActividadRoute = new ActividadControlRouteGenSpImpl();
                        ActividadControlOperationGenSpImpl oActividadControlOperation = new ActividadControlOperationGenSpImpl(request);
                        jsonResult = oActividadRoute.execute(request, oActividadControlOperation);
                        break;
                    case "tipoactividad":
                        TipoactividadControlRouteGenSpImpl oTipoactividadRoute = new TipoactividadControlRouteGenSpImpl();
                        TipoactividadControlOperationGenSpImpl oTipoactividadControlOperation = new TipoactividadControlOperationGenSpImpl(request);
                        jsonResult = oTipoactividadRoute.execute(request, oTipoactividadControlOperation);
                        break;
